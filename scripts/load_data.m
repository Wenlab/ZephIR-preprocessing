...
datasetpath = '/Users/quanwen/Documents/GitHub/calcium imaging';

red_stacks_filename = [datasetpath,'/', 'ImgStk001_dk001_w6_Dt231025_{red}_{from-3119-to-5118}_{1to50-trimed}.mat'];
green_stacks_filename = [datasetpath, '/','ImgStk001_dk001_w6_Dt231025_{Green}_{from-3119-to-5118}_{fliped}_{1to50-trimed}.mat'];
